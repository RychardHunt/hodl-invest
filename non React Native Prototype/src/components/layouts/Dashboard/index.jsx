            ...
            <div className="row">
              <div className="col-sm-3 col-md-2 sidebar">
                <div className="text-center">
                  <h2 className="brand">Imperium Romanum<br /><small>Crypto Mutual Fund</small></h2>
                ...
                <ul className="nav nav-sidebar">
                  ...
                  <li>
                    <Link to="/dashboard/reports">Investment Portfolio</Link>
                  </li>

                  <li>
                    <a href="https://www.livecoinwatch.com/">Live Cryptocurrency Market</a>
                  </li>
