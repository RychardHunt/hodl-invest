...
var _StaticRenderer = require('../../modules/StaticRenderer');
  ...
  ListView.prototype.render = function render() {
    ...
    for (var sectionIdx = 0; sectionIdx < allRowIDs.length; sectionIdx++) {
      ...
      for (var rowIdx = 0; rowIdx < rowIDs.length; rowIdx++) {
        ...
        if (renderSeparator && (rowIdx !== rowIDs.length - 1 || sectionIdx === allRowIDs.length - 1)) {
  ...
  ListView.prototype._updateVisibleRows = function _updateVisibleRows(updatedFrames) {
    ...
    if (updatedFrames) {
      updatedFrames.forEach(function (newFrame) {
        _this5._childFrames[newFrame.index] = Object.assign({}, newFrame);
      });
    }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._onLayout = function (event) {
    ...
    var visibleLength = !_this7.props.horizontal ? height : width;
  ...
  this._onContentSizeChange = function (width, height) {
    var contentLength = !_this7.props.horizontal ? height : width;
  ...
  this._onScroll = function (e) {
    ...
    _this7.scrollProperties.visibleLength = e.nativeEvent.layoutMeasurement[isVertical ? 'height' : 'width'];
    _this7.scrollProperties.contentLength = e.nativeEvent.contentSize[isVertical ? 'height' : 'width'];
    ...
    if (_this7.props.onEndReached && _this7._getDistanceFromEnd(_this7.scrollProperties) > _this7.props.onEndReachedThreshold) {
